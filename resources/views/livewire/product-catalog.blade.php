    ...
    <div class="grid grid-cols-1 gap-10 md:grid-cols-10">
        <div class="grid grid-cols-1 gap-10 pr-6 border-r border-gray-200 md:col-span-3">
            <div>
                <div class="space-y-3">
                    ...
                    @error('search')
                        <div class="text-sm text-red-500 space-y-3">
                            {{ $message }}
                        </div>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-2 mt-10">
                    ...
                    <button type="button" wire:click="resetFilters"
                        class="inline-flex items-center justify-center text-sm font-semibold text-gray-600 rounded-lg cursor-pointer gap-x-2 hover:text-gray-800 focus:outline-hidden focus:text-gray-800 disabled:opacity-50 disabled:pointer-events-none dark:text-gray-500 dark:hover:text-gray-400 dark:focus:text-gray-400">
                        Reset
                    </button>
                </div>
            </div>
        ...
        <div class="col-span-1 md:col-span-7">
            <div class="flex items-center justify-between gap-5">
                <div class="font-light text-gray-800">Results: {{ $products ? $products->total() : 0 }}</div>
